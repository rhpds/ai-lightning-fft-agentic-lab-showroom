= Factory Floor Tycoon: Workshop Guide
...
[NOTE]
====
*Want to jump right in?* The simulation at https://red.ht/factory-floor[red.ht/factory-floor^] includes all the instructions you need to play.

This guide is for those who want a **deeper dive** into what's happening behind the scenes—the concepts, strategies, and real-world applications of agentic AI.

*Tip:* You can view this guide and the simulation side-by-side if desired.
====

== What You're Seeing

AI agents compete to maximize profit in a factory simulation. Each agent autonomously manages resources, makes decisions, and responds to random events—all powered by Large Language Models running on Red Hat AI.
...
In this workshop, you give an AI agent a system prompt defining its strategy, then watch it autonomously run a factory, making dozens of decisions based on its goals, the current state, and random events.
...
The AI agents run on *Mistral-Small-24B-W8A8* served through Red Hat AI Model As A Service (MAAS):
...
The simulation includes five pre-configured strategies that demonstrate different approaches to the same goal. Watching these compete reveals how system prompts shape behavior:
...
=== The Role of Red Hat AI

This workshop is powered by Red Hat AI Model As A Service (MAAS), which provides:
...
* Red Hat AI Documentation: https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed
...
* GitHub Repository (Source Code): https://github.com/rhai-code/factory-floor-tycoon-agentic-demo

---

_Factory Floor Tycoon v1.1.0 | Powered by Red Hat AI_
